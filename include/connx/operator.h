...
#define CONNX_GET_ATTRIBUTE_OFFSET(idx)		backend->attribute_index[CONNX_GET_ATTRIBUTE_INDEX(idx)]

#define CONNX_GET_OUTPUT(idx)			connx_Backend_get_variable(backend, CONNX_GET_OUTPUT_INDEX(idx))
#define CONNX_SET_OUTPUT(idx, tensor)	connx_Backend_set_variable(backend, CONNX_GET_OUTPUT_INDEX(idx), (tensor))
#define CONNX_GET_INPUT(idx)			connx_Backend_get_variable(backend, CONNX_GET_INPUT_INDEX(idx))
#define CONNX_GET_ATTRIBUTE(idx)		connx_Backend_get_attribute(backend, CONNX_GET_ATTRIBUTE_INDEX(idx))
